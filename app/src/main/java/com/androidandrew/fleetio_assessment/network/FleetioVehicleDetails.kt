...
data class FleetioVehicleDetails(
    ...
    @SerialName("current_meter_value") val meter1Value: Long,
    ...
    @SerialName("secondary_meter_value") val meter2Value: Long? = null,
